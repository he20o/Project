		...
		<div class="goods">
			...
			<input type="hidden" name="category" value="kids">
				<div class="ga">
					<div id="ga_1">
						<input type="checkbox" name="kids"
							value="파리 2024 줄보 퓨리 쿨 애티튜드 선글라스 - 화이트">파리 2024 줄보 퓨리 쿨
						애티튜드 선글라스 - 화이트<br> <br> <img src=s_pic/kids_a.jpg><br>
						<br>
						<hr>
						£90⁰⁰ / 122,000원
					</div>
				...
				<div class="gb">
					<div id="gb_1">
						<input type="checkbox" name="kids"
							value="파리 2024 패럴림픽 마스코트 티셔츠 - 네이비">파리 2024 패럴림픽 마스코트 티셔츠
						-네이비<br> <br> <img src=s_pic/kids_b.jpg><br>
						<br>
						<hr>
						£14⁰⁰ / 19,000원
					</div>
				...
				<div class="gc">
					<div id="gc_1">
						<input type="checkbox" name="kids"
							value="프랑스 올림픽 팀 르꼬끄 스포티트 크루 스웨트"> 프랑스 올림픽 팀 로꼬끄 스포티트 크루
						스웨트<br> <br> <img src=s_pic/kids_c.jpg><br> <br>
						<hr>
						£65⁰⁰ / 88,000원
					</div>
					<br>
				...
				<div class="gd">
					<div id="gd_1"><br>
						<input type="checkbox" name="kids"
							value="파리 2024 올림픽 마스코트 후디 - 네이비">파리 2024 올림픽 마스코트 후디
						-네이비<br> <br> <img src=s_pic/kids_d.jpg><br>
						<br>
						<hr>
						£40⁰⁰ / 54,000원
					</div>
				...
				<div class="ge">
					<div id="ge_1">
						<input type="checkbox" name="kids"
							value=" 파리 2024 올림픽 라지 로고 티셔츠 -화이트"> 파리 2024 올림픽 라지 로고
						티셔츠 - 화이트<br> <br> <img src=s_pic/kids_e.jpg> <br>
						<br>
						<hr>
						£16⁰⁰ / 22,000원
					</div>
