...
<body>
	...
	<div class="shop">
		...
		<div class="goods">
			...
			<input type="hidden" name="category" value="woman">
				<div class="ga">
					<div id="ga_1">
						<input type="checkbox" name="woman"
							value="프랑스 올림픽 팀 르꼬끄 스웨트 - 네이비"> 프랑스 올림픽 팀 르꼬끄 스웨트 - 네이비<br>
						<br>
						<img src=s_pic/woman_a.jpg><br> <br>
						<hr>
						£80⁰⁰ / 108,000원
					</div>
					<br>
				...
				<div class="gb">
					<div id="gb_1">
						<input type="checkbox" name="woman"
							value="프랑스 올림픽 팀 르꼬끄 티셔츠 - 화이트"> 프랑스 올림픽 팀 르꼬끄 티셔츠 - 화이트
						<br> <br>
						<img src=s_pic/woman_b.jpg><br> <br>
						<hr>
						£33⁰⁰ / 45,000원
					</div>
					<br>
				...
				<div class="gc">
					<div id="gc_1">
						<input type="checkbox" name="woman" value="프랑스 올림픽 팀 르꼬끄 재킷 - 네이비">
						프랑스 올림픽 팀 르꼬끄 재킷 - 네이비<br> <br>
						<img src=s_pic/woman_c.jpg><br> <br>
						<hr>
						£140⁰⁰ / 189,000원
					</div>
					<br>
				...
				<div class="gd">
					<div id="ge_1"><br>
						<input type="checkbox" name="woman" value="파리 2024 올림픽 르콕 파카 재킷 ">
						파리 2024 올림픽 르콕 파카 재킷 <br> <br>
						<img src=s_pic/woman_d.jpg><br> <br>
						<hr>
						£155⁰⁰ / 210,000원
					</div>
					<br>
				...
				<div class="ge">
					<div id="ge_1">
						<input type="checkbox" name="woman"
							value=" 파리 2024 올림픽 기본 로고 그래픽 후디 - 그레이"> 파리 2024 올림픽 기본
						로고 그래픽 후디 - 그레이<br> <br>
						<img src=s_pic/woman_e.jpg><br> <br>
						<hr>
						£55⁰⁰ / 75,000원
					</div>
					<br>
