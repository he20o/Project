...
String styleCss1 = application.getRealPath("Payment.css");
...
<link rel="stylesheet"
	href="Payment.css?ver=<%=fmt1.format(lastModifiedStyle)%>">

</head>
<body>
<%
String a= request.getParameter("o_game");
String b = request.getParameter("p_game");
%>
	<div id="top">
		<h1>
			🗼<i>PARIS 2024</i>🗼
...
<div class ="card_box">
	<h3>〰️ 신용카드 결제 〰️</h3>
	<div id ="cardinfo">
	<form action="T_result.jsp" method="get">
<input type="hidden" name="olym" value="<%=a %>">
<input type="hidden" name="paralym" value="<%=b %>">
<br>
